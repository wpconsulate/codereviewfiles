...
class FormService
{
    ...
    {
        return $this->render('input')->type('file')->name($name)->label($label)->identifier('filecontrol')->file_placeholder("Browse Files");
    }

    /**
     * File Input Browse placeholder text
     *
     * @param string $label
     * @return FormService
     */
    public function file_placeholder($str): FormService
    {
        return $this->_set('file_placeholder', $str);
    }
     ...
     * possible attr
        ...
        *  "thumb_class" => "img-circle img-fluid",
     ...
     * @return FormService
     */
    public function ajaxUpload(string $name = null, string $label = null, $placeholder=null, $default=null, $attr = [ "input_text"=>"Browse", "button_text" => "Upload"  ] ): FormService
    {
        return $this->render('ajaxUpload')->type('file')->name($name)->label($label)->placeholder($placeholder)->value($default)->_set('attr', $attr);
    }
    ...
    /**
     * Create a google location input
     *
     * @param string $name
     * @param string $label
     * @param string $default
     * @param string $lat_default
     * @param string $lng_default
     * @return FormService
     */
    public function location(string $name = null, $label = null, string $default = null, string $lat_default = null, string $lng_default = null): FormService
    {
        return $this->render('location')
                        ...
                        ->identifier('location')
                        ->_set('value_lat', $lat_default)
                        ->_set('value_lng', $lng_default);
    }

    /**
     * Set the location lat field name
     *
     * @param string $name
     * @return FormService
     */
    public function locationLatName(string $name = null): FormService
    {
        return $this->_set('lat_name', $name);
    }
    /**
     * Set the location lng field name
     *
     * @param string $name
     * @return FormService
     */
    public function locationLngName(string $name = null): FormService
    {
        return $this->_set('lng_name', $name);
    }
     ...
     * @return FormService
     */
    public function datetime(string $name = null, $label = null, string $default = null): FormService
    {
     ...
     * @return FormService
     */
    public function date(string $name = null, string $label = null, string $default = null): FormService
    {
        // return $this->render('input')->type('date')->name($name)->label($label)->value($default);
        return $this->render('input')
                ->type('text')
     ...
     * @return FormService
     */
    public function select2(string $name = null, string $label = null, $options = [], $default = null): FormService
    {
        return $this->select($name, $label, $options, $default)->icon('fa fa-caret-down')->identifier('select2');
    }


    /**
     * Create a CustomSelect input
     *
     * @param string $name
     * @param string $label
     * @param array $options
     ...
     * @return FormService
     */
    public function customSelect(string $name = null, string $label = null, $options = [], $default = null): FormService
    {
        return $this->render('customSelect')->name($name)->label($label)->options($options)->value($default)->identifier('customSelect');
    }
     ...
     * @return FormService
     */
    public function hideLabel(): FormService
    {
        return $this->_set('hideLabel', 1);
    }
     ...
     * @return FormService
     */
    public function icon(string $icon = null): FormService
    {
        return $this->_set('icon', $icon);
    }
     ...
     * @return FormService
     */
    public function identifier(string $identifier = null): FormService
    {
